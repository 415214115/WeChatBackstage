	...
	<el-card class="rditors">
		...
		<el-form class="formDatas" label-width="80px" :model="postData">
			<el-form-item label="标题">
				<el-input v-model="postData.title" disabled></el-input>
			</el-form-item>
			<el-form-item label="类型">
				<el-select v-model="postData.type" disabled placeholder="请选择">
...
<script>
	...
	export default {
		...
		methods: {
			...
			getPageData() {
					this.$request.postJson('/back/type/selectInformationOne', {
						...
						if (res.code == 'succes') {
							...
							this.postData.cover = res.data.cover
							this.postData.context = res.data.context
						}
					})
			}
		}
